...
: ${AMENT_CURRENT_PREFIX:="/root/ws_offboard_control/install/comp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/comp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/comp/environment/path.sh"
