...
{
  new (message_memory) px4_msgs::msg::ParameterResetRequest(_init);
}

void ParameterResetRequest_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::ParameterResetRequest *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ParameterResetRequest_message_member_array[3] = {
  {
    ...
    offsetof(px4_msgs::msg::ParameterResetRequest, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::ParameterResetRequest, parameter_index),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::ParameterResetRequest, reset_all),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::ParameterResetRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, ParameterResetRequest)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::ParameterResetRequest_message_type_support_handle;
}
