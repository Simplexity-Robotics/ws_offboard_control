...
static rosidl_typesupport_introspection_c__MessageMember RoverAckermannGuidanceStatus__rosidl_typesupport_introspection_c__RoverAckermannGuidanceStatus_message_member_array[7] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__RoverAckermannGuidanceStatus, actual_speed),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__RoverAckermannGuidanceStatus, crosstrack_error),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
