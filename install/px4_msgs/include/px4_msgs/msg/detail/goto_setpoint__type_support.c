...
void GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_init_function(
...
void GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_fini_function(void * message_memory)
{
  px4_msgs__msg__GotoSetpoint__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_message_member_array[10] = {
  {
    "timestamp",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_message_members = {
  "px4_msgs__msg",  // message namespace
  "GotoSetpoint",  // message name
  10,  // number of fields
  sizeof(px4_msgs__msg__GotoSetpoint),
  GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_message_member_array,  // message members
  GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_init_function,  // function to initialize message memory (memory has to be allocated)
  GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_message_type_support_handle = {
  0,
  &GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, GotoSetpoint)() {
  if (!GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_message_type_support_handle.typesupport_identifier) {
    GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GotoSetpoint__rosidl_typesupport_introspection_c__GotoSetpoint_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
