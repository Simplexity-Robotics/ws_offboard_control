...
void ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_init_function(
...
void ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_fini_function(void * message_memory)
{
  px4_msgs__msg__ArmingCheckReply__fini(message_memory);
}

size_t ArmingCheckReply__rosidl_typesupport_introspection_c__size_function__Event__events(
...
const void * ArmingCheckReply__rosidl_typesupport_introspection_c__get_const_function__Event__events(
...
void * ArmingCheckReply__rosidl_typesupport_introspection_c__get_function__Event__events(
...
static rosidl_typesupport_introspection_c__MessageMember ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_message_member_array[20] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    ArmingCheckReply__rosidl_typesupport_introspection_c__size_function__Event__events,  // size() function pointer
    ArmingCheckReply__rosidl_typesupport_introspection_c__get_const_function__Event__events,  // get_const(index) function pointer
    ArmingCheckReply__rosidl_typesupport_introspection_c__get_function__Event__events,  // get(index) function pointer
    NULL  // resize(index) function pointer
  },
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_message_members = {
  "px4_msgs__msg",  // message namespace
  "ArmingCheckReply",  // message name
  20,  // number of fields
  sizeof(px4_msgs__msg__ArmingCheckReply),
  ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_message_member_array,  // message members
  ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_init_function,  // function to initialize message memory (memory has to be allocated)
  ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_message_type_support_handle = {
  0,
  &ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, ArmingCheckReply)() {
  ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_message_member_array[9].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, Event)();
  if (!ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_message_type_support_handle.typesupport_identifier) {
    ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
