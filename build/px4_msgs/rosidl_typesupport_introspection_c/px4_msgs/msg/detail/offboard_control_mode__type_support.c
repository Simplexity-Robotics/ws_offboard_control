...
static rosidl_typesupport_introspection_c__MessageMember OffboardControlMode__rosidl_typesupport_introspection_c__OffboardControlMode_message_member_array[8] = {
  {
    "timestamp",  // name
