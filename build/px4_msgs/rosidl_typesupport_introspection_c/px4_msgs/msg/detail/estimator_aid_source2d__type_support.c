...
static rosidl_typesupport_introspection_c__MessageMember EstimatorAidSource2d__rosidl_typesupport_introspection_c__EstimatorAidSource2d_message_member_array[14] = {
  {
    "timestamp",  // name
