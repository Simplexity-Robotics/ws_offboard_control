...
static const _DifferentialDriveSetpoint_type_support_symbol_names_t _DifferentialDriveSetpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, DifferentialDriveSetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, DifferentialDriveSetpoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4_msgs, msg, DifferentialDriveSetpoint)() {
  return &::px4_msgs::msg::rosidl_typesupport_c::DifferentialDriveSetpoint_message_type_support_handle;
}
