...
{
  new (message_memory) px4_msgs::msg::ParameterSetValueRequest(_init);
}

void ParameterSetValueRequest_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::ParameterSetValueRequest *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ParameterSetValueRequest_message_member_array[4] = {
  {
    ...
    offsetof(px4_msgs::msg::ParameterSetValueRequest, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::ParameterSetValueRequest, parameter_index),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::ParameterSetValueRequest, int_value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::ParameterSetValueRequest, float_value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ParameterSetValueRequest_message_members = {
  ...
  4,  // number of fields
  sizeof(px4_msgs::msg::ParameterSetValueRequest),
...
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::ParameterSetValueRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, ParameterSetValueRequest)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::ParameterSetValueRequest_message_type_support_handle;
}
