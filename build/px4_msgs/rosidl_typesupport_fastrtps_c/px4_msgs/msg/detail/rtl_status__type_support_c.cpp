...
#include "px4_msgs/msg/detail/rtl_status__rosidl_typesupport_fastrtps_c.h"
...
using _RtlStatus__ros_msg_type = px4_msgs__msg__RtlStatus;
...
static uint32_t _RtlStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__RtlStatus(
...
{
  return max_serialized_size_px4_msgs__msg__RtlStatus(
    full_bounded, 0);
}
