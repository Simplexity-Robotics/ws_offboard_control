...
#include "px4_msgs/msg/detail/figure_eight_status__rosidl_typesupport_fastrtps_c.h"
...
using _FigureEightStatus__ros_msg_type = px4_msgs__msg__FigureEightStatus;
...
size_t get_serialized_size_px4_msgs__msg__FigureEightStatus(
  const void * untyped_ros_message,
...
static uint32_t _FigureEightStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__FigureEightStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_px4_msgs__msg__FigureEightStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _FigureEightStatus__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4_msgs__msg__FigureEightStatus(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, FigureEightStatus)() {
